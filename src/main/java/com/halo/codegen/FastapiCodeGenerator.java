...
public class FastapiCodeGenerator extends AbstractPythonCodegen {
  ...
  final Logger LOGGER = LoggerFactory.getLogger(FastapiCodeGenerator.class);

  private static final String NAME = "halo-fastapi1";
