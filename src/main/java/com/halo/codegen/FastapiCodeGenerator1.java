...
public class FastapiCodeGenerator1 extends AbstractPythonConnexionServerCodegen {
  private static final Logger LOGGER = LoggerFactory.getLogger(FastapiCodeGenerator1.class);
  ...
  public FastapiCodeGenerator1() {
    super("halo-fastapi1", false);
     ...
     */
    // added
    this.apiTemplateFiles.put("handler.mustache", "_service.py");
