 ...
 * 1) Set a break point in FlaskCodeGenerator.java in the postProcessOperationsWithModels() method.
...
public class MycodeGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("halo-flask") // use this codegen library
              ...
              .setOutputDir("out/code"); // output directory
